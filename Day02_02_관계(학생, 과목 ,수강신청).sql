...
CREATE TABLE SUPPORT_TBL(
    ...
    STU_NO VARCHAR2(5 BYTE) NOT NULL,
    SUB_CODE VARCHAR2(3 BYTE),
    CONSTRAINT PK_COMM_NO PRIMARY KEY(COMM_NO),
    CONSTRAINT FK_STU_NO FOREIGN KEY(STU_NO) REFERENCES STU_TBL(STU_NO),
    CONSTRAINT FK_SUB_CODE FOREIGN KEY(SUB_CODE) REFERENCES SUB_TBL(SUB_CODE)
);