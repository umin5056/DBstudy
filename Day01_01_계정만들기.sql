...
/*
    ...
    4. 새로운 계정을 만드는 방법
        1) DROP USER 계정이름 CASCADE : 기존에 생성된 계정이 있다면 삭제한다. CASCADE는 계정이 가진 데이터도 함께 삭제하라는 옵션이다.
...
/*
    ...
    2. 모든 쿼리를 실행 : F5 (새로 고침 아님)
*/


DROP USER GDJ61 CASCADE; -- CASCADE는 계정이 가진 테이블도 지우는 옵션이다.
